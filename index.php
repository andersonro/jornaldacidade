...
iniciarRow();
    iniciarCol(12,12,12,12,'fundo_preto');
        iniciarRow();
            iniciarCol(12,12,6,6,'noticia-1 noticia');
                echo '<a href="noticia-detalhe.php?n=1">';
                    echo '<span class="icone_tags icone_tags_position">Música</span>';
                        gerarImg($PATH.'imagens/noticias/noticia1.jpeg','img-noticias-efeito','',TRUE);
            ...
            iniciarCol(12,12,5,5);
                iniciarRow();
                    iniciarCol(12,12,12,12,'noticia-2 noticia');
                        echo '<a href="noticia-detalhe.php?n=1">';
                            echo '<span class="icone_tags icone_tags_position1">Politica</span>';
                            gerarImg($PATH.'imagens/noticias/noticia2.jpg','img-noticias-efeito');
                ...
                iniciarRow();
                    iniciarCol(12,12,12,12,'noticia-2 noticia');
                        echo '<a href="noticia-detalhe.php?n=1">';
                            ...
                            gerarImg($PATH.'imagens/noticias/noticia3.jpg','img-noticias-efeito');
                            echo '<span class="noticia-titulo noticia-titulo-2">Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos</span>';
                        echo '</a>';
                    finalizarCol();
                finalizarRow();
            ...
            for ($i=0; $i < 7; $i++) { 
                ...
                echo '<a href="noticia-detalhe.php?n='.$i.'">';
                    echo '<div class="colunista">';
                        ...
                        echo '<p class="colunista-resumo font-12 font-center font-color-cinza-escuro">
                                '.substr($loremIpsum, 0,150).'
                              </p>';
